...
const get_aluno = (id,edit) => {
    ...
    .then(re => {
        ...
        if (edit == 0){
            ...
            document.querySelector(".infos__datanasc").innerHTML = `<input class="input" type="date" value="`+re.aluno.user__data_nasc+`"  name="data_nasc">`
            document.querySelector(".infos__cep").innerHTML = `<input type="number" class="input" id="inputs" name="cep" onfocusout="buscarCep(event)" value="`+re.aluno.user__cep+`" required>`
            document.querySelector(".infos__cidade").innerHTML = `<input type="text" class="input" id="inputs" name="cidade" value="`+re.aluno.user__cidade+`" required>`
            document.querySelector(".infos__logra").innerHTML = `<input type="text" class="input" id="inputs" name="logradouro" value="`+re.aluno.user__endereco+`" required>`
            document.querySelector(".infos__bairro").innerHTML = `<input type="text" class="input" id="inputs" name="bairro" value="`+re.aluno.user__bairro+`" required>`
            document.querySelector(".infos__num").innerHTML = `<input type="number" class="input" id="inputs" name="numero" value="`+re.aluno.user__numero+`" required>`
            document.querySelector(".infos__uf").innerHTML = `<input type="text" class="input" id="inputs" name="uf" value="`+re.aluno.user__uf+`" required>`
